...
interface ButtonProps {
  (props: CardsProps): React.ReactElement;
}

export const SelectBtn: ButtonProps = (props: CardsProps) => {
  return (
    <button
      style={{
      ...
      className={"addToFav"}
      onClick={() => props.selectCard(props.cardData, props.selectedCards)}
    />
  );
};
